...
public struct BCHTransactionByHashResponseModel {
    ...
    public let inputs: [BCHTransactInputResponseModel]
    public let outputs: [BCHTransactOutputResponseModel]
}
...
public struct BCHTransactInputResponseModel {
...
extension BCHTransactInputResponseModel: Codable {
    enum CodingKeys: String, CodingKey {
        case address
...
public struct BCHTransactOutputResponseModel: Codable {
    public let address: String?
