...
public struct BTCTransactionByHashResponseModel {
    ...
    public let inputs: [BTCTransactInputResponseModel]
    public let outputs: [BTCTransactOutputResponseModel]
}
...
public struct BTCTransactInputResponseModel {
...
extension BTCTransactInputResponseModel: Codable {
    enum CodingKeys: String, CodingKey {
        case address
...
public struct BTCTransactOutputResponseModel: Codable {
    public let address: String?
