...
@interface LTCTransactionInput : NSObject <NSCopying>
...
@property(nonatomic) LTCOutpoint* outpoint;
...
@property(nonatomic) LTCScript* signatureScript;
...
@property(nonatomic) LTCTransactionOutput* transactionOutput;
