...
#ifndef CoreLitecoin_LTCSignatureHashType_h
#define CoreLitecoin_LTCSignatureHashType_h
...
typedef NS_ENUM(unsigned char, LTCSignatureHashType)
{
    ...
    LTC_SIGHASH_ALL          = 1,
    LTCSignatureHashTypeAll = LTC_SIGHASH_ALL,
    ...
    LTC_SIGHASH_NONE         = 2,
    LTCSignatureHashTypeNone = LTC_SIGHASH_NONE,
    ...
    LTC_SIGHASH_SINGLE       = 3,
    LTCSignatureHashTypeSingle = LTC_SIGHASH_SINGLE,
    ...
    LTC_SIGHASH_OUTPUT_MASK  = 0x1F,
    LTCSignatureHashTypeOutputMask = LTC_SIGHASH_OUTPUT_MASK,
    ...
    // E.g. a crowdfunding transaction with 100 LTC output can be signed independently by any number of people
    ...
    LTC_SIGHASH_ANYONECANPAY = 0x80,
    LTCSignatureHashTypeAnyoneCanPay = LTC_SIGHASH_ANYONECANPAY,
};
