...
typedef NS_ENUM(NSInteger, LTCCurrencyConverterMode) {
    /*!
     * Uses the average exchange rate to convert btc to fiat and back.
     */
    LTCCurrencyConverterModeAverage  = 0,
     ...
     */
    LTCCurrencyConverterModeBuy      = 10,
...
/*!
 * Buy exchange rate (price for 1 LTC when you buy LTC).
...
/*!
 * Sell exchange rate (price for 1 LTC when you sell LTC).
