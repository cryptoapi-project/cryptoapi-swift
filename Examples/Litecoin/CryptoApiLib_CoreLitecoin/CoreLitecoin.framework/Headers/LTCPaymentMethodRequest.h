...
extern NSInteger const LTCPaymentMethodRequestVersion1;

@interface LTCPaymentMethodRequest : NSObject
...
@property(nonatomic, readonly, nonnull) LTCPaymentMethodDetails* details;
