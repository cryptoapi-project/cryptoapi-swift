...
//   LTCPublicKeyAddressTestnet, 
//   LTCPrivateKeyAddressTestnet, 
//   LTCScriptHashAddressTestnet.
//
@class LTCKey;
@class LTCNetwork;
@interface LTCAddress : NSObject

/*!
 * Allows subclasses to be instantiated by a call to a superclass: LTCAddress(string: "...")
 */
 ...
 */
@property(nonatomic, readonly, nonnull) LTCAddress* publicAddress;
...
@interface LTCPublicKeyAddress : LTCAddress
@end
...
@interface LTCPrivateKeyAddress : LTCAddress
...
// Returns LTCKey containing a key pair. Its public key is compressed as specified by the address.
@property(nonatomic, readonly, nonnull) LTCKey* key;
...
@end
@interface LTCPrivateKeyAddressTestnet : LTCPrivateKeyAddress
@end

// P2SH address (e.g. 3NukJ6fYZJ5Kk8bPjycAnruZkE5Q7UW7i8)
@interface LTCScriptHashAddress : LTCAddress
@end
@interface LTCScriptHashAddressTestnet : LTCScriptHashAddress
@end
