...
static uint32_t const LTCTransactionOutputIndexUnknown = 0xffffffff;
...
// Index of this output in its transaction. Default is LTCTransactionOutputIndexUnknown
