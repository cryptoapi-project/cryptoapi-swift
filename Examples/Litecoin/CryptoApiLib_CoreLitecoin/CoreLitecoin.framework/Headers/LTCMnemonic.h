...
@property(nonatomic, readonly) LTCKeychain* keychain;
...
// If `password` is nil, it is treated as an empty string.
// If `wordListType` is LTCMnemonicWordListTypeUnknown, checksum is not verified.
