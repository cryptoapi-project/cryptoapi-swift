...
@class LTCBigNumber;
@class LTCBlock;
@interface LTCNetwork : NSObject <NSCopying>
...
@property(nonatomic) LTCBigNumber* proofOfWorkLimit;

// Array of pairs @[ @(int <height>), NSData* <hash> ] sorted by height.
@property(nonatomic) NSArray* checkpoints;


// Returns a checkpoint hash if it exists or LTC256Zero if there is no checkpoint at such height.
