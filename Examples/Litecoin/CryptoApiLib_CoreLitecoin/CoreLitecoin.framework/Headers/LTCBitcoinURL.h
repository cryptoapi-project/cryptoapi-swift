...
@class LTCAddress;
@class LTCAssetID;
@interface LTCBitcoinURL : NSObject

/*!
 * Encoded address.
 */
@property(nonatomic, nullable) LTCAddress* address;
 ...
 */
@property(nonatomic, nullable) LTCAssetID* assetID;
 ...
 * @param amount  Amount in satoshis. Note that URI scheme dictates to render this amount as a decimal number in LTC.
 * @param label   Optional label.
 */
+ (nonnull NSURL*) URLWithAddress:(nonnull LTCAddress*)address amount:(LTCAmount)amount label:(nullable NSString*)label;
